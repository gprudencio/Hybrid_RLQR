...
def plot_lat_long_rewd(episode_long_rewards, episode_lat_rewards):

    np.savetxt('./auxiliar/LongRewards.txt', episode_long_rewards, fmt='%.5f', newline='\n')
    np.savetxt('./auxiliar/LatRewards.txt', episode_lat_rewards, fmt='%.5f', newline='\n')
